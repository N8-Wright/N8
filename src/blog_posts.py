...
class BlogPosts:
    def __init__(self, db_path):
        ...
        db_connection = sqlite3.connect(db_path, autocommit=False)
    ...
    def create_post(self, name: str, content: str) -> UUID:
        db_connection = sqlite3.connect(self.db_pat, autocommit=False)
        cursor = db_connection.cursor()
    ...
    def update_post(self, id: UUID, name: str, content: str) -> None:
        db_connection = sqlite3.connect(self.db_path, autocommit=False)
        cursor = db_connection.cursor()
